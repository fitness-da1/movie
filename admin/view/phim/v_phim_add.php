...
<!--                                    <input type="text" class="form-control" id="description" name="description" placeholder="Mô tả">-->
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-9">
                                    <select class="select2 form-control m-t-15" multiple="multiple" style="height: 36px;width: 100%;" name="the_loai[]">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <input type="number" min="0" class="form-control" id="thoi_luong" name="thoi_luong" placeholder="Thời lượng">
                                </div>
                            </div>
                            <div class="form-group row">
